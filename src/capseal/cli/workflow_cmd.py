    ...
    Example workflow file (YAML):
        ...
        tasks:
          ...
          - id: explain
            ...
            needs: [semgrep]
    """
    from capseal.workflow_engine import WorkflowSpec, WorkflowRunner
...
def verify_workflow_command(run_dir: str, verify_proof: bool) -> None:
    ...
    """
    from capseal.workflow_engine import verify_workflow_rollup
    ...
    capsule_valid = True
    if verify_proof:
        from capseal.workflow_adapter import verify_workflow_capsule
...
def verify_capsule_command(capsule_file: str) -> None:
    ...
    if schema == "workflow_capsule_v1":
        ...
        from capseal.eval_adapter import verify_eval_capsule
