...
"""
    ...
    def _get_cli_root(self):
        ...
        from capseal.cli import cli as capseal_cli
        return capseal_cli
    ...
    def _print_status(self) -> None:
        ...
        # Receipt stats
        try:
            from capseal.mcp_server import EVENT_LOG_PATH
    ...
    def do_generate(self, arg: str) -> None:
        ...
        # Build command
        from capseal.cli.run import _find_project_root
    ...
    def do_diff(self, arg: str) -> None:
        ...
        """
        try:
            from capseal.mcp_server import (
                tool_diff_bundle,
                EVENT_LOG_PATH,
            )
    ...
    def _spawn_subagent(self, task: str) -> None:
        ...
        try:
            from capseal.mcp_server import tool_spawn_agent
    ...
    def _show_plan(self, mode: str) -> None:
        ...
        try:
            ...
            from capseal.cli.orchestrate import Orchestrator
    ...
    def _scoped_review(self, mode: str) -> None:
        ...
        try:
            ...
            from capseal.cli.context import load_context
            from capseal.cli.orchestrate import (
                Orchestrator, parse_agent_output
            )
            from capseal.mcp_server import tool_spawn_agent, tool_save_result
    ...
    def _collect_agent_results(self) -> None:
        ...
        try:
            from capseal.mcp_server import tool_collect_results
...
Be strategic about parallelization. Each subagent works independently."""
    ...
    def do_sync(self, arg: str) -> None:
        ...
        if do_index:
            ...
            try:
                from capseal.cli.greptile import _api_request, _parse_repo_string
    ...
    def do_refactor(self, arg: str) -> None:
        ...
        try:
            ...
            from capseal.refactor_engine import PatchVerification
            verifications = [
                PatchVerification(
        ...
        try:
            ...
            if num_agents > 1:
                ...
                def llm_patch_generator(items: list[dict], project_dir: Path):
                    ...
                    from capseal.refactor_engine import RefactorPlan, RefactorItem
            ...
            if enable_critic:
                ...
                try:
                    from capseal.critic_agent import (
            ...
            if critic_result and critic_result.challenges:
                try:
                    ...
                    if critic_obligations_path.exists():
                        ...
                        from capseal.critic_agent import CriticObligation
    ...
    def do_prove(self, arg: str) -> None:
        ...
        try:
            ...
            if findings_path.exists():
                from capseal.refactor_engine import sha256_json
            ...
            if diff_path.exists():
                from capseal.refactor_engine import sha256_str
...
"""
    ...
    def do_context(self, arg: str) -> None:
        ...
        """
        try:
            from capseal.cli.context import (
    ...
    def do_merge(self, arg: str) -> None:
        ...
        try:
            from capseal.cli.merge import merge_command
            from click.testing import CliRunner
...
Say "UNCERTAIN" with reasoning if context is incomplete or ambiguous.""")
    ...
    def _process_ask_with_patches(
        ...
        # Import verification
        try:
            from capseal.claims import Claim, ClaimType, Verdict, Scope, Witness
            from capseal.checkers import ast_checker, semgrep_checker
