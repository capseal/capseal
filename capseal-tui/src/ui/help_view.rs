...
impl Widget for HelpView {
    fn render(self, area: Rect, buf: &mut Buffer) {
        ...
        let lines = vec![
            ...
            help_line("  Ctrl+H", "Toggle focus (panel/terminal)", key_style, desc_style),
            Line::raw(""),
