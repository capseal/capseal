...
from bef_zk.capsule.explain_pipeline import run_explain_pipeline
...
class ProfileExtractExecutor(NodeExecutor):
    ...
    def execute(self, spec: NodeSpec, context: dict) -> NodeResult:
        from bef_zk.capsule.cli.profile_cmd import extract_profile
...
class IntentCheckExecutor(NodeExecutor):
    ...
    def execute(self, spec: NodeSpec, context: dict) -> NodeResult:
        from bef_zk.capsule.cli.profile_cmd import (
...
try:
    from bef_zk.capsule.committor_gate import CommittorGateExecutor
...
try:
    from bef_zk.capsule.refactor_engine import REFACTOR_EXECUTORS
...
class WorkflowRunner:
    ...
    def _generate_workflow_proof(self) -> None:
        ...
        """
        from bef_zk.capsule.workflow_adapter import (
            WorkflowAdapter,
